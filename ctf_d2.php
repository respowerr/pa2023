...
$log_message = $timestamp . " - " . $_SESSION['username'] . " on page " . "CTF-D2" . "\n";
...
<form class="ctf_" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    <p class="title is-5" style="color:white">One day, in the wonderful world of Paint, a smiling little man finds himself mysteriously lost amidst a colorful backdrop. He seems a bit bewildered, but don't worry, he is indeed present in the drawing. Your mission, if you choose to accept it, is to solve the puzzle and determine exactly where this little man is hiding. So, get ready with your detective brushes and your colors of reflection because the artistic adventure begins !</p>
    <p for="response" class="title is-5" style="color:white">Your mission : Find a localisation.</p>
    <p for="response" class="title is-5" style="color:white">Answer must be in lowercase and without accents. Exemple : berlin</p>
    <a class="download-button" href="ctf_source/D2_soldier.png" download="soldat.png">Download</a>
    <?php if (isset($rep)) : ?>
