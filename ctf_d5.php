...
$log_message = $timestamp . " - " . $_SESSION['username'] . " on page " . "CTF-D5" . "\n";
...
<form class="ctf_" method="post">
    <p class="title is-5" style="color:white">You are about to embark on an exciting challenge that will test your skills in cybersecurity. You have been informed that a suspicious audio file has been discovered on a compromised computer. Your task is to analyze this file to determine if it contains any sensitive information. The audio file in question is a short, low-noise recording that appears to have been created recently. It does not provide any obvious clues on how to find the answer. Your mission is to carefully examine the file, dig deep into its contents, and uncover any hidden secrets or vulnerabilities it may hold.Remember, attention to detail and a methodical approach will be key to your success. Good luck, and may the challenge begin!</p>
    <p for="response" class="title is-5" style="color:white">Your mission : WHERE I AM ???</p>
    <p for="response" class="title is-5" style="color:white">Answer must be in uppercase and without accents. Exemple : OH_NO</p>
    <a class="download-button" href="ctf_source/D5_itsnothing.wav" download="it'snothing.wav">Download</a>
<?php if (isset($rep)) : ?>
