...
$log_message = $timestamp . " - " . $_SESSION['username'] . " on page " . "CTF-D3" . "\n";
...
if (isset($_POST["response"])) {
  ...
  if($response == "birmingham_oratory"){
    if($level>($levelPage)){
...
<form class="ctf_" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    <p class="title is-5" style="color:white">Once upon a time, my dear friend Alex embarked on a vacation to an exotic land. Their excitement was contagious as they shared stories of breathtaking landscapes and fascinating cultures. As a surprise, before leaving, Alex handed me a photograph, saying, "I have a mission for you!" In the picture, a magnificent monument stood tall against a backdrop of lush greenery. Driven by curiosity and a sense of adventure, I eagerly accepted the task. Armed with the photograph and a thirst for discovery, I delved into research, scouring travel blogs, books, and online resources. I followed leads and analyzed architectural styles, seeking any clue that could unravel the mystery. The challenge awaits—will you answer the call and become the hero of this captivating quest?</p>
    <p for="response" class="title is-5" style="color:white">Your mission : Find the name of the place.</p>
    <p for="response" class="title is-5" style="color:white">Answer must be in lowercase and without accents. Exemple : eiffel_tower</p>
    <a class="download-button" href="ctf_source/D3_wow.jpg" download="wow.png">Download</a>
    <?php if (isset($rep)) : ?>
